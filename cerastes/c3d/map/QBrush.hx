...
class Brush extends cerastes.c3d.Brush.BaseBrush
{
	var bodies: Array<BulletBody> = [];
	var brush: QBrush;

	public override function create( def: EntityData, qworld: World  )
	{
	...
	public function buildBrush( def: MapEntityData )
	{
	...
	function createStaticCollision( def: MapEntityData )
	{
